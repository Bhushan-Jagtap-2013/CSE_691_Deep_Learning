...
sample_lr = [5e-08, 0.5e-7, 0.7e-7, 0.1e-7]
sample_reg = [4.6e4, 2.8e4, 4e4, 7.2e4, 5.4e4, 1.6e4]
...
sample_lr = [0.2e-7, 0.5e-7, 0.7e-7, 2e-7]
sample_reg = [3.6e4, 2.8e4, 4e4, 7.2e4, 5.4e4, 1e4]
